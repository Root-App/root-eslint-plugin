// Copied from https://github.com/benmosher/eslint-plugin-import/blob/1f7422d2e06e4f6accd68031e5768dd38a7ac18a/src/rules/no-extraneous-dependencies.js
...
var _docsUrl = require('eslint-plugin-import/lib/docsUrl');
...
function extractDepFields(pkg) {
  return {
    ...
    moduleName: pkg.name || "no-name-detected"
  };
}
...
function reportIfMissing(context, deps, depsOptions, node, name) {
  ...
  const isSameModule = deps.moduleName === packageName;

  if (isInDeps || isSameModule || depsOptions.allowDevDeps && isInDevDeps || depsOptions.allowPeerDeps && isInPeerDeps || depsOptions.allowOptDeps && isInOptDeps || depsOptions.allowBundledDeps && isInBundledDeps) {
    return;
  }
